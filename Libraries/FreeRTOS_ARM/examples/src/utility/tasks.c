...
void vTaskSwitchContext( void )
{
	...
	else
	{
		...
		traceTASK_SWITCHED_IN();
                ...
                if (pxCurrentTCB->uxTCBNumber<32) GPBR->SYS_GPBR[0] = pxCurrentTCB->uxTCBNumber<<8; // Запомнить текущую задачу сдвинув значение на 8 бит влево (место для номера ошибки)
