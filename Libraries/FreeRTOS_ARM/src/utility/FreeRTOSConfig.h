...
#define configMINIMAL_STACK_SIZE		( ( unsigned short ) 50 )  // 100, 150, pav2000 было 130, 200 - виснет после 2-5 часов
...
#define STAT_FREE_RTOS    // Сбор статистики, если не нужно то закоментировать именно здесь!
  #ifdef STAT_FREE_RTOS
    #define configGENERATE_RUN_TIME_STATS	 1    	// 0 - отключить статистику  1 - включить
	#define configGENERATE_RUN_TIME_STATS_TASKLIST 	// combine vTaskList with vTaskGetRunTimeStats (vad711)
    extern volatile unsigned long  ulHighFrequencyTimerTicks;
    #define portCONFIGURE_TIMER_FOR_RUN_TIME_STATS() (ulHighFrequencyTimerTicks = 0UL )
    #define portGET_RUN_TIME_COUNTER_VALUE()	 (ulHighFrequencyTimerTicks=xTaskGetTickCount())
    #define configUSE_STATS_FORMATTING_FUNCTIONS  1	// 1 - разделить ':' и не форматировать имя, 2 - разделить табуляцией, дополнить имя пробелами
    #define configUSE_TRACE_FACILITY              1
  #else
  //  #error ======= configGENERATE_RUN_TIME_STATS =========
   #define configGENERATE_RUN_TIME_STATS         0    // 0 - отключить статистику  1 - включить
...
#define configLIBRARY_MAX_SYSCALL_INTERRUPT_PRIORITY     10  // WHG
