...
Stats_Data Stats_data[] = {
	...
	{ 0, STATS_OBJ_Power, STATS_TYPE_SUM, STATS_WHEN_WORKD, OBJ_powerCO },	// #6
	{ 0, STATS_OBJ_Power, STATS_TYPE_SUM, STATS_WHEN_ALWAYS, OBJ_power220 },// #7
	...
	{ 0, STATS_OBJ_COP, STATS_TYPE_AVG, 6, 7 }, // индексы Stats_data[]: STATS_OBJ_Power(SUM, OBJ_powerCO) / STATS_OBJ_Power(SUM, OBJ_power220)
