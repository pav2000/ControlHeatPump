...
#define VERSION         "0.957 beta"        // Версия прошивки
#ifndef UART_SPEED
...
#define SDM_DELAY_REPEAD    100            // мсек Время между ПОВТОРНЫМИ попытками чтения                      было 150
...
#define SALLMONELA_TIME   (90*60)        // Максимальная продолжительность цикла (сек), что бы цикл не длился бесконечно при не возможности достижения SALLMONELA_TEMP
