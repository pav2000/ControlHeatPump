...
#define VERSION			"1.077"				// Версия прошивки
#define VER_SAVE		144					// Версия формата сохраняемых данных в I2C память
#ifndef UART_SPEED
...
// 0x0A00 - I2C_PROFILE_EEPROM хранение профилей, максимальный размер 0x1000 (4096) байт. Число профилей 10 шт. Размер профиля сейчас 290 байт (2900)
