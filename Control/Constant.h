...
#define VERSION			"1.018"				// Версия прошивки
#define VER_SAVE		132					// Версия формата сохраняемых данных в I2C память
#ifndef UART_SPEED
...
// 0х0080 - I2C_SETTING_EEPROM хранение настроек ТН  максимальный размер 0х980 (2432) байт. Сейчас используется 1095 байт
...
#define HYSTERESIS_BoilerAddHeat      200 // Гистерезис нагрева бойлера до температуры догрева, в сотых градуса
...
const char *boil_fBoilerPID   = {"PID"};                 // пока резерв, не используется
...
const char *chart_TPEVA     = {"T[PEVA]"};                   // температура расчитанная из давления Испарения
