...
#define VERSION         "0.996 beta"        // Версия прошивки
...
#define HYSTERESIS_BoilerTogetherHeat 100 // Гистерезис совместного нагрева бойлера с отоплением в сотых градуса
...
const char *option_DELAY_TRV          = {"DLTRV"};        		// Задержка между переключением 4-х ходового клапана и включением компрессора, для выравнивания давлений (сек). Если включены эти опции (переключение тепло-холод)
