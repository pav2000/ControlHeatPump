...
#define VERSION			"2.02"				// Версия прошивки после слияния веток
...
#define MQTT_NUM_ERR_OFF   16             // Число ошибок отправки подряд при котором отключается сервис отправки MQTT (флаг сбрасывается)
