...
#define VERSION         "0.961 beta"        // Версия прошивки
#ifndef UART_SPEED
...
// 0х0080 - I2C_SETTING_EEPROM хранение настроек ТН  максимальный размер 0х580 (1408) байт. Сейчас используется 1215 байта
