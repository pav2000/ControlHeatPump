...
#define VERSION			"1.072"				// Версия прошивки
...
// 0х0080 - I2C_SETTING_EEPROM хранение настроек ТН  максимальный размер 0х980 (2432) байт. Сейчас используется 1113 байт
// 0x0A00 - I2C_PROFILE_EEPROM хранение профилей, максимальный размер 0x1000 (4096) байт. Число профилей 10 шт. Размер профиля сейчас 286 байт (2860)
// 0x1A00 - I2C_SCHEDULER_EEPROM хранения расписаний, максимум 0x5FE (1534) байт (сейчас 346 байта)
