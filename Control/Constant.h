...
#define ERR_EMPTY_1         -81        // !!!!!!!!!!!!!!!!!!!!!!!! можно занять этот номер
#define ERR_EMPTY_2         -82        // !!!!!!!!!!!!!!!!!!!!!!!!  можно занять этот номер
...
const char *noteError[] = {"Ok",                                                  //  0
                           ...
                           "Попытка включить компрессор при неработающих насосах контуров",                     //-80
                           "Пусто 1",                                                                           //-81
                           "Пусто 2",                                                                           //-82
