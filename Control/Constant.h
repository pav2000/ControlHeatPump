...
#define VERSION			"1.052"				// Версия прошивки
#define VER_SAVE		138					// Версия формата сохраняемых данных в I2C память
#ifndef UART_SPEED
...
#endif
#define SDM_NUM_READ        3              // Число попыток чтения счетчика (подряд) по модбас до его отключения (ошибка не генерится)
...
// 0x0A00 - I2C_PROFILE_EEPROM хранение профилей, максимальный размер 0x1000 (4096) байт. Число профилей 10 шт. Размер профиля сейчас 301 байт (3010)
