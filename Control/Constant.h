...
#define VER_SAVE          124               // Версия формата сохраняемых данных, при чтении если версии не совпадают, отказ от чтения. ВСЕГДА 2 БАЙТА тип uint16_t
...
// 0х0080 - I2C_SETTING_EEPROM хранение настроек ТН  максимальный размер 0х580 (1408) байт. Сейчас используется 1081 байта
