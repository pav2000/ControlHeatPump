...
#define VERSION         "0.960 beta"        // Версия прошивки
#ifndef UART_SPEED
...
#define VER_SAVE          127               // Версия формата сохраняемых данных
...
// 0х0080 - I2C_SETTING_EEPROM хранение настроек ТН  максимальный размер 0х580 (1408) байт. Сейчас используется 1106 байта
// 0х0600 - I2C_PROFILE_EEPROM хранение профилей, максимальный размер 0x9ff(2559) байт. Число профилей 8 шт. Размер профиля сейчас  267 байт (8*267=2136)
