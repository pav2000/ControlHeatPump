...
//"request.open(\"GET\", \"http://77.50.254.24:25401/&\" + reqstr + \"&&\", true); // адрес и порт контроллера\r\n"
...
"     updateParam(\"get_version,get_testMode,get_datetime(TIME),get_datetime(DATE),get_WORK,get_uptime,get_freeRam,get_loadingCPU,get_uptime,get_paramEEV(OVERHEAT),get_MODE,get_error,get_errcode,get_Temp(TOUT),get_Temp(TIN),get_Temp(TEVAING),get_Temp(TEVAOUTG),get_Temp(TCONING),get_Temp(TCONOUTG),get_Temp(TBOILER)\");\r\n"
" };\r\n"
" </script> \r\n"
" <style>\r\n"
...
"<span style=\"font-size:0.8em;font-style:italic;line-height:1em\">SD карта не работает, показана упрощеная версия интерфейса. Для устраниния ошибки попробуйте на выключеном контроллере переставить карту, и выполнить сброс  контроллера. <br/><input style=\"margin-top:15px;\" type=\"submit\" value=\"Сброс контроллера\"  onclick='loadParam(\"RESET\")'><a href=\"/journal.txt\" download=\"\"><button>Загрузить журнал</button></a></span>"
"   </dd> \r\n"
" </dl> \r\n"
"</div> \r\n"
"</body>\r\n"
