...
"Расположение файлов веб-сервера на SPI Flash <input type='checkbox' id='get_optionhp-wspif' onChange='setParam(\"get_optionHP(WSPIF)\");'><br>"
