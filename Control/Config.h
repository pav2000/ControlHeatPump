...
//        "Температура на выходе теплоаккумулятора",
  ...
  */
  ...
  #define EEV_DEF                     // Наличие ЭРВ в конфигурации
	...
	#define OHCor_CONDENSING_30_MUL 22			  // Корректировка разницы Нагнетание-Конденсация на кажлые 10 градусов конденсации от 30 (в десятых), зависит от фреона
	#define OHCor_EVAPORATING_0_MUL 46			  // Корректировка разницы Нагнетание-Конденсация на кажлые -10 градусов испарения от 0 (в десятых), зависит от фреона
    // ЭРВ Времена и задержки
