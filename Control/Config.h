...
//	#define WR_CurrentSensor_4_20mA	IWR								// Использовать аналоговый датчик тока с выходом 4-20mA, номер ADC датчика
	...
	#define PWM_CALC_POWER_ARRAY		2							// Расчет массива точной мощности, 1 - Сбрасывать мощность между шагами, 2 - нет
	#define PWM_CALC_POWER_SW_SKIP		2							// Сколько значений пропускать после изменения мощности
	const uint8_t PWM_POWER_ARRAY[101] = { 255,236,227,222,218,214,211,208,205,203,200,198,196,194,192,190,188,187,185,183,181,180,178,177,175,174,172,171,169,168,167,166,164,163,162,160,159,158,156,155,154,152,151,150,148,146,145,143,142,141,139,138,137,135,134,132,131,130,128,127,125,124,122,121,119,118,117,115,113,112,111,110,109,107,106,104,103,102,100,98,97,95,93,91,89,87,85,83,81,78,76,72,69,65,61,54,46,35,20,0 ,0 };
#endif
