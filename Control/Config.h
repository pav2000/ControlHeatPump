...
// -----------------------------------------------------------------------------------------------------------------------------------
 ...
 //   #define DEFROST                                                         // нужна разморозка
   ...
   //    #define ONEWIRE_DONT_CHG_RES                                         // Не записывать 12-битное разрешение в датчик при привязке, а просто устанавливать
     ...
     #define STACK_vUpdateCommand  230             // 160 Стек задачи выполнение команд управления (разбор очереди комманд)
     #define STACK_vUpdateStat     150             // 150 Стек задачи накопление статистики    
     #define STACK_vWebX           300             // 230 Стек задачи веб морды один поток (потоков может быть 1-4)
...
// Описание реле
  ...
  */
  ...
  #endif
  // ------------------- ADC SENSOR ----------------------------------
  #define P_NUMSAMLES       2              // Число значений для усреднения показаний давления
  #define PRESS_FREQ        120            // период опроса аналоговых датчиков
  #define FILTER_SIZE       100            // Длина фильтра для датчиков давления
  #define FILTER_SIZE_OTHER 10             // Длина фильтра для остальных датчиков
