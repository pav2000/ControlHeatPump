...
struct type_boilerHP
{
 ...
 int8_t	 add_delta_temp; 	           // Добавка температуры к установке бойлера, в градусах
 ...
 int8_t P1;                            // Резервный параметр 1
};
...
struct type_settingHP
{
 ...
 int8_t	 add_delta_temp;		      // Добавка температуры к установке отопления, в градусах
