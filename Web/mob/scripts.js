...
var rer = new RegExp('BIG_NARMON|USE_TS|ADD_BOILER|USE_NARMON|USE_MQTT|BIG_MQTT|SDM_MQTT|FC_MQTT|COP_MQTT|NO_PING|set_SDM|ENABLE_PROFILE|ON_OFF|get_paramFC[(]ANALOG[)]|sensorUseIP|sensorRuleIP|NO_ACK|MESS_RESET|MESS_WARNING|MESS_SD|MESS_TEMP|MESS_LIFE|MESS_ERROR|[(]MAIL[)]|MAIL_AUTH|MAIL_INFO|[(]SMS[)]|et_Relay|UPDATE_I2C|et_optionHP[(]SAVE_ON|Boiler[(]BOILER_ON|Boiler[(]SCH_ON|Boiler[(]ADD_HEATING|Boiler[(]SALLMONELA|et_Network[(]DHCP|INIT_W5200|et_Network[(]PASSWORD|RESET_HEAT|CIRCULATION|et_optionHP[(]SD_CARD|[(]WEATHER[)]|et_optionHP[(]BEEP|RTV_OFF|et_optionHP[(]NEXTION|et_optionHP[(]EEV_CLOSE|et_optionHP[(]EEV_START|get_datetime[(]UPDATE');
